...
using CoreGraphics;
using Foundation;
using Homence_Smart_Device;
using Homence_Smart_Device.iOS.Renders;
using UIKit;
using Xamarin.Forms;
using Xamarin.Forms.Platform.iOS;

[assembly: ExportRenderer(typeof(CustomEntry), typeof(CustomEntryRender))]
namespace Homence_Smart_Device.iOS.Renders
{
    public class CustomEntryRender : EntryRendererBase<UITextFieldPadding>
    {
